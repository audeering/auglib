...
@pytest.mark.parametrize(
    ...
    [
        ...
        (1, 0, to_db(0.5), to_db(0.3), [0.5, 1, 1, 1, 1, 1]),
        (0, 1, to_db(0.5), to_db(0.3), [1, 1, 1, 1, 1, 0.3]),
        (1, 1, to_db(0.5), to_db(0.3), [0.5, 1, 1, 1, 1, 0.3]),
        (1, 1, to_db(0.5), -120, [0.5, 1, 1, 1, 1, 0]),
        (1, 1, -120, to_db(0.3), [0, 1, 1, 1, 1, 0.3]),
    ]
)
def test_Fade(
        sampling_rate,
